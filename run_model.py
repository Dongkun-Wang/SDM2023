...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str,
                        default='PPP', help='the name of model')
    parser.add_argument('--teacher', type=str,
                        default='TGCN', help='the name of teacher model')
    parser.add_argument('--distill', type=str,
                        default='avg', help='the type of distillation')
    ...
    run_model(task=args.task, model_name=args.model, dataset_name=args.dataset,
              ...
              train=args.train, teacher_model=args.teacher, other_args=other_args)
